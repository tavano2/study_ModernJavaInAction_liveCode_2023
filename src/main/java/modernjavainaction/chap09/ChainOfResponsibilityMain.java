...
public class ChainOfResponsibilityMain {
  ...
  public static void main(String[] args) {
    ...
    UnaryOperator<String> header = t -> "From Raoul, Mario and Alan: " + t;
    UnaryOperator<String> footer = t -> t.replaceAll("labda","lambda");
    Function<String,String> pipeline2 = header.andThen(footer);
    String result3 = pipeline2.apply("Hey, 이것도 테스트 되니?");
