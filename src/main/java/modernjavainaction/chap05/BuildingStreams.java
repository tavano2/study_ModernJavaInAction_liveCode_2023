...
public class BuildingStreams {
  ...
  public static void main(String... args) throws Exception {
    ...
    URL resource = BuildingStreams.class.getResource("/modernjavainaction/chap05/data.txt");
    long uniqueWords = Files.lines(Paths.get(resource.toURI()), Charset.defaultCharset())
